package com.adobe.aem.journeymate.core.models;

import com.adobe.aem.journeymate.core.models.ImageList;
...
public class ImageListImpl implements ImageList {
    ...
    protected static final String RESOURCE_TYPE = "journeymate/components/image-list";
